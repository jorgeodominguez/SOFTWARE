...
class Detalle_compra(models.Model):
    ...
    costo=models.DecimalField('Costo',max_digits=5,decimal_places=2)
    fecha=models.DateField("Fecha de Validacion")
    observacion=models.TextField('Observacion',max_length=100)
...
class Proveedor(models.Model):
    ...
    telefono=models.CharField("Telfono",max_length=20)
...
class Articulo(models.Model):
    ...
    rin=models.DecimalField("Rin",max_digits=5,decimal_places=2,null=False)
